...
var Slider = function (props) {
    ...
    var _a = react.useState(false), sliderIsBeingTouched = _a[0], setSliderIsBeingTouched = _a[1];
    ...
    return (jsx("div", { style: { padding: 20, backgroundColor: 'blue' } },
        jsx("input", { type: "range", onChange: handleChange, onTouchEnd: handleTouchEnd, onTouchStart: handleTouchStart, css: inputStyle, value: props.value, disabled: props.disabled }),
        jsx("p", { style: { color: 'white' } }, "TEST")));
};
Slider.defaultProps = {
    disabled: false,
};
